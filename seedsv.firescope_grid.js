/*
** seedsv
** Copyright (C) 2006-2008  seedsv Inc.
*/
/*
seedsv Grid
...
<ul>
	...
	- seedsv_total replaced with calling id + '_total' to allow multiple grids on one page<br/>	
	...
	- added seedsv_offset parm to be returned on ajax calls; 
	  &nbsp;&nbsp;&nbsp;&nbsp;to save a user calculation of: (seedsv_page - 1) * seedsv_rows<br/>
	...
	- &lt;span id="seedsv_total" style="display:none"&gt;'.$total.'&lt;/span&gt; is no longer required; <br/>
...
*/
jQuery.fn.seedsv = function(options) {
	...
	var cfg = {
        ...
        msgFilterHelp:             '<enter text to filter>',
        ...
        msgLoading:                '<img src="seedsv/load.gif"> Loading..',
	...
	var g = {
		...
		gotoPage: function(page) {
			...
			var parms = {
				seedsv_page: cfg.page,
				seedsv_rows: cfg.rows,
				seedsv_offset: (cfg.page - 1) * cfg.rows,
				seedsv_sortCol: cfg.sortCol, 
				seedsv_sortOrder: cfg.sortOrder,
				seedsv_filterCol: cfg.filterCol, 
				seedsv_filterText: cfg.filterText				
			};
